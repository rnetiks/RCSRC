...
public class FengGameManagerMKII : Photon.MonoBehaviour
{
    ...
    private void RecompilePlayer()
    {
        this.photonView.RPC("RecompilePlayerRPC", PhotonTargets.All);
    }
    ...
    [RPC]
    private void RecompilePlayerRPC(PhotonMessageInfo info)
    {
        string iteratorVariable1 = string.Empty;
        if (!info.sender.customProperties.ContainsKey((object)"RCteam"))
           return;
     }
