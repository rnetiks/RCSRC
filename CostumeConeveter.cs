...
public class CostumeConeveter
{
    ...
    public static HeroCostume PhotonDataToHeroCostume(PhotonPlayer player)
    {
        ...
        costume.hairInfo = (costume.sex != SEX.MALE) ? CostumeHair.hairsF[(int)player.customProperties[PhotonPlayerProperty.hairInfo]] : CostumeHair.hairsM[(int)player.customProperties[PhotonPlayerProperty.hairInfo]];
